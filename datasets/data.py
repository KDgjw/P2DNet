...
class DataloadTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # resample(0~pc_list[ht].shape[0] choice Num)
        for ht in range(len(pc_list)):
        ...
        # print("pcds_xyzi = " + str(pcds_xyzi))
        # print("pcds_coord = " + str(pcds_coord))
        # print("pcds_sphere_coord = " + str(pcds_sphere_coord))
        # print("pcds_target = " + str(pcds_target))
        # print("pcds_flow = " + str(pcds_flow))
        # exit()
